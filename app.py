...
if not st.session_state.autenticado:
    ...
    st.markdown(
        """
        <h1 style='text-align:center;color:#7A1735;'>
        🔐 Acceso Seguro
        </h1>
        """,
...
archivo_bd = st.sidebar.file_uploader(
    "Subir Consolidada",
    type=["xlsb", "xlsx"]
)
...
def generar_ppt(df_base):
    ...
    RUTA_MACHOTE = "MACHOTE_PRESENTACIÓN.pptx"
